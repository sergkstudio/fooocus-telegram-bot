...
async def handle_message(update: Update, context):
    try:
        ...
        job = client.predict(
            True, user_input, "", ["Fooocus V2"], "Quality", "704×1408",
            1, "png", "", True, 0, 1.5,
            "juggernautXL_v8Rundiffusion.safetensors", "None", 0.1,
            True, "None", -2,
            True, "None", -2,
            True, "None", -2,
            True, "None", -2,
            ...
            "Original Prompts", True, "person",
            "high quality", "low quality",
            "u2net", "full", "vit_b",
            0.7, 0.3, 10,
            True, "None", 1.0, 0.618, -64, True,
            True, "person", "high quality", "low quality",
            "u2net", "full", "vit_b",
            0.7, 0.3, 10,
            True, "None", 1.0, 0.618, -64, True,
            # Параметры 101-153
